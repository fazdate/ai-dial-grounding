...
def retrieve_context(user_question: str) -> list[dict[str, Any]]:
    ...
    messages = [
        SystemMessagePromptTemplate.from_template(QUERY_ANALYSIS_PROMPT).format(format_instructions=parser.get_format_instructions()),
    ...
    if search_requests.search_request_parameters:
        requests_dict = {}
        for req in search_requests.search_request_parameters:
            requests_dict[req.search_field.value] = req.search_value
        print(requests_dict)
